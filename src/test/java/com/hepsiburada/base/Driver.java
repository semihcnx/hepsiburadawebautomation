...
import com.hepsiburada.methods.ActionMethods;
import com.hepsiburada.methods.JsMethods;
import com.hepsiburada.methods.Methods;
import com.hepsiburada.methods.MethodsUtil;
import com.hepsiburada.step.StepImplementation;
import com.hepsiburada.utils.ReadProperties;
...
public class Driver {
    ...
    public static String osName = com.hepsiburada.base.FindOS.getOperationSystemName();
    ...
    public void beforePlan(){
        ...
        if(!logLevel.equals("ALL")) {
            ...
            getLogger(com.hepsiburada.base.LocalBrowserExec.class).setLevel(Level.ALL);
            getLogger(com.hepsiburada.base.FindOS.class).setLevel(Level.ALL);
    ...
    public void createDriver() throws Exception {
        ...
        if(StringUtils.isEmpty(key)) {
            isTestinium = false;
            platformName = com.hepsiburada.base.FindOS.getOperationSystemNameExpanded();
            driver = com.hepsiburada.base.LocalBrowserExec.LocalExec(browserName);
        }
